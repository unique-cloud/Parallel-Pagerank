...
set_module_property NAME power_system
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME power_system
set_module_property TOP_LEVEL_HDL_FILE power_system.v
set_module_property TOP_LEVEL_HDL_MODULE power_system
...
### SLAVE interface avs_fpgasort_cra
add_interface avs_fpgasort_cra avalon end
set_interface_property avs_fpgasort_cra addressAlignment DYNAMIC
set_interface_property avs_fpgasort_cra burstOnBurstBoundariesOnly false
set_interface_property avs_fpgasort_cra explicitAddressSpan 0
set_interface_property avs_fpgasort_cra holdTime 0
set_interface_property avs_fpgasort_cra isMemoryDevice false
set_interface_property avs_fpgasort_cra isNonVolatileStorage false
set_interface_property avs_fpgasort_cra linewrapBursts false
set_interface_property avs_fpgasort_cra maximumPendingReadTransactions 1
set_interface_property avs_fpgasort_cra printableDevice false
set_interface_property avs_fpgasort_cra readLatency 0
set_interface_property avs_fpgasort_cra readWaitTime 1
set_interface_property avs_fpgasort_cra setupTime 0
set_interface_property avs_fpgasort_cra timingUnits Cycles
set_interface_property avs_fpgasort_cra writeWaitTime 0
set_interface_property avs_fpgasort_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_fpgasort_cra ENABLED true
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_read read Input 1
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_write write Input 1
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_address address Input 5
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_writedata writedata Input 64
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_byteenable byteenable Input 8
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_waitrequest waitrequest Output 1
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_readdata readdata Output 64
add_interface_port avs_fpgasort_cra avs_fpgasort_cra_readdatavalid readdatavalid Output 1
...
add_file acl_fp_custom_clz.v {SYNTHESIS SIMULATION}
add_file acl_fp_div_s5_double.hex {SYNTHESIS SIMULATION}
add_file acl_fp_div_s5_double.v {SYNTHESIS SIMULATION}
...
add_file acl_optimized_clz_27.v {SYNTHESIS SIMULATION}
...
add_file lsu_ic_top.v {SYNTHESIS SIMULATION}
...
add_file power.v {SYNTHESIS SIMULATION}
