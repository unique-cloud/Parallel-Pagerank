...
set_module_property NAME edge_centric_system
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME edge_centric_system
set_module_property TOP_LEVEL_HDL_FILE edge_centric_system.v
set_module_property TOP_LEVEL_HDL_MODULE edge_centric_system
...
### SLAVE interface avs_scatter_cra
add_interface avs_scatter_cra avalon end
set_interface_property avs_scatter_cra addressAlignment DYNAMIC
set_interface_property avs_scatter_cra burstOnBurstBoundariesOnly false
set_interface_property avs_scatter_cra explicitAddressSpan 0
set_interface_property avs_scatter_cra holdTime 0
set_interface_property avs_scatter_cra isMemoryDevice false
set_interface_property avs_scatter_cra isNonVolatileStorage false
set_interface_property avs_scatter_cra linewrapBursts false
set_interface_property avs_scatter_cra maximumPendingReadTransactions 1
set_interface_property avs_scatter_cra printableDevice false
set_interface_property avs_scatter_cra readLatency 0
set_interface_property avs_scatter_cra readWaitTime 1
set_interface_property avs_scatter_cra setupTime 0
set_interface_property avs_scatter_cra timingUnits Cycles
set_interface_property avs_scatter_cra writeWaitTime 0
set_interface_property avs_scatter_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_scatter_cra ENABLED true
add_interface_port avs_scatter_cra avs_scatter_cra_read read Input 1
add_interface_port avs_scatter_cra avs_scatter_cra_write write Input 1
add_interface_port avs_scatter_cra avs_scatter_cra_address address Input 5
add_interface_port avs_scatter_cra avs_scatter_cra_writedata writedata Input 64
add_interface_port avs_scatter_cra avs_scatter_cra_byteenable byteenable Input 8
add_interface_port avs_scatter_cra avs_scatter_cra_waitrequest waitrequest Output 1
add_interface_port avs_scatter_cra avs_scatter_cra_readdata readdata Output 64
add_interface_port avs_scatter_cra avs_scatter_cra_readdatavalid readdatavalid Output 1

### SLAVE interface avs_gather_cra
add_interface avs_gather_cra avalon end
set_interface_property avs_gather_cra addressAlignment DYNAMIC
set_interface_property avs_gather_cra burstOnBurstBoundariesOnly false
set_interface_property avs_gather_cra explicitAddressSpan 0
set_interface_property avs_gather_cra holdTime 0
set_interface_property avs_gather_cra isMemoryDevice false
set_interface_property avs_gather_cra isNonVolatileStorage false
set_interface_property avs_gather_cra linewrapBursts false
set_interface_property avs_gather_cra maximumPendingReadTransactions 1
set_interface_property avs_gather_cra printableDevice false
set_interface_property avs_gather_cra readLatency 0
set_interface_property avs_gather_cra readWaitTime 1
set_interface_property avs_gather_cra setupTime 0
set_interface_property avs_gather_cra timingUnits Cycles
set_interface_property avs_gather_cra writeWaitTime 0
set_interface_property avs_gather_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_gather_cra ENABLED true
add_interface_port avs_gather_cra avs_gather_cra_read read Input 1
add_interface_port avs_gather_cra avs_gather_cra_write write Input 1
add_interface_port avs_gather_cra avs_gather_cra_address address Input 5
add_interface_port avs_gather_cra avs_gather_cra_writedata writedata Input 64
add_interface_port avs_gather_cra avs_gather_cra_byteenable byteenable Input 8
add_interface_port avs_gather_cra avs_gather_cra_waitrequest waitrequest Output 1
add_interface_port avs_gather_cra avs_gather_cra_readdata readdata Output 64
add_interface_port avs_gather_cra avs_gather_cra_readdatavalid readdatavalid Output 1
...
add_file edge_centric.v {SYNTHESIS SIMULATION}
